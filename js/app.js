...
$('#close').click(()=>{
    ...
    if($('#close').attr('class') == "btn btn-danger btn-sm") {
        ...
        $('#close').attr('class', 'btn-success btn btn-sm rounded-circle')
        $('#close').children().attr('class', 'bi bi-chevron-up')
    } else{
        $('#close').removeAttr('class', 'btn-success')
        $('#close').removeAttr('class', 'btn-success')
        $('#close').attr('class', 'btn btn-danger btn-sm rounded-circle')
        $('#close').children().attr('class', 'bi bi-chevron-compact-down')
    }
})